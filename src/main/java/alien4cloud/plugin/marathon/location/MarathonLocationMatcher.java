...
@Slf4j
@Component("marathon-location-matcher")
public class MarathonLocationMatcher implements ILocationMatcher {
    ...
    public List<ILocationMatch> match(Topology topology) throws LocationMatchingException {
        ...
        try {
            ...
            new MarathonLocationMatchOrchestratorFilter(selfContext).filter(matched, topology);
            return matched;
        } catch (Exception e) {
